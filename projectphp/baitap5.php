...
<div class="container pt-5">
    ...
    <button class="btn btn-outline-info float-right" data-toggle="modal" data-target="#form-add"><i class="fas fa-plus"></i> Thêm</button>
                ...
                <td>
                    <div class="modal" id="form-edit-<?php echo $value->id?>">
                        <div class="modal-dialog">
                            ...
                            <!-- Modal Header -->
                            <div class="modal-header">
                                <h4 class="modal-title">Sửa với ID: <?php echo $value->id?></h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <!-- Modal body -->
                            <form action="" method="POST">
                    ...
                    <button class="btn btn-outline-success" data-toggle="modal" data-target="#form-edit-<?php echo $value->id?>"><i class="fas fa-pencil-alt"></i> Sửa</button>
                    <form action="" style=" display: inline-block;" method="POST">
                        <input type="hidden" name="action" value="delete"> 
                        <input type="hidden" name="id" value="<?php echo $value->id?>"> 
                        <button  class="btn btn-outline-darkr"><i class="fas fa-trash-alt"></i> Xoá</button>
                    </form>
                </td>
            </tr>    
            <?php 
